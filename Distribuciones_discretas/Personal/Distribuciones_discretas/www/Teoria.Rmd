...
Por definición, el cuantil de orden $p^*$  de una distribución de probabilidad es aquel valor de la distribución que deja a su izquierda una proporción de valores $p^*$ (o, equivalentemente, un porcentaje del ($p^*$×100)).  Esto es, el cuantil de orden $p^*$, será aquel valor $x^*$ tal que:


$$P(X \leq x^*) = p^*$$

Si la variable aleatoria $X$ no se asume continua, la hipotesis nula esta dada por:


$$H_0: \text{El}~p^*\text{-ésimo cuantil de}~X~\text{es}~x^*~\text{(se debe especificar)}$$

Que es equivalente a:


$$H_0: P(X \leq x^*) \geq p^*~y~P(X < x^*) \leq p^*$$
